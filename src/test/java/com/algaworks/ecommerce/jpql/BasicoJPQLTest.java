...
public class BasicoJPQLTest extends EntityManagerTest {
    ...
    public void ordenarResultados() {
        ...
        TypedQuery<Cliente> typedQueryCliente = entityManager.createQuery(jpql, Cliente.class);

        List<Cliente> lista = typedQueryCliente.getResultList();
    ...
    public void buscarPorIdentificador() {
        ...
        Pedido pedido = typedQuery.getSingleResult(); //Dará problema se o resultado não for exatamente 1
